...
function renderTools() {
  ...
  if (toolMode === "split") {
    ...
    h += '<p style="font-size:13px;margin-bottom:16px;color:' + T.tm + '">Убирает пробелы, запятые и лишние символы между префиксом и номером.<br>';
    h += '<span style="font-family:\'JetBrains Mono\',monospace;color:' + T.td + '">TKRU 4236025,</span> → <span style="font-family:\'JetBrains Mono\',monospace;color:#2ed573">TKRU4236025</span></p>';
  }

...
function renderPlanner() {
  ...
  h += '<button class="tgl" style="background:' + (showShared ? T.ab : 'transparent') + ';border:1px solid ' + (showShared ? T.ac + '66' : T.cb) + ';color:' + (showShared ? T.at : T.tm) + '" onclick="toggleShared()"><span class="dot" style="background:' + (showShared ? "#2ed573" : T.td) + ';' + (showShared ? 'box-shadow:0 0 8px #2ed573' : '') + '"></span>👥 Общие</button>';
